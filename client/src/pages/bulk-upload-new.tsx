...
function BulkUploadContent({ user }: BulkUploadProps) {
  ...
  const validateFileMutation = useMutation({
    mutationFn: async (fileData: FormData) => {
      try {
        console.log('🔍 FRONTEND: Starting file validation request...');
        console.log('🔍 FRONTEND: FormData in mutation:', Array.from(fileData.entries()));
  ...
  const handleValidateFile = () => {
    try {
      console.log('🔍 FRONTEND: Starting handleValidateFile...');
      ...
      console.log('🔍 FRONTEND: File type validation passed');
      
      const formData = new FormData();
      formData.append('file', file);
      
      console.log('🔍 FRONTEND: FormData created, calling validateFileMutation.mutate');
      console.log('🔍 FRONTEND: FormData entries:', Array.from(formData.entries()));
      
      validateFileMutation.mutate(formData);
      console.log('🔍 FRONTEND: validateFileMutation.mutate called');
    } catch (error) {
      console.error('🔍 FRONTEND ERROR in handleValidateFile:', error);
      toast({
        title: "Error",
