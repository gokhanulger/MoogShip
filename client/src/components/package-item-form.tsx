...
import { Trash2, Plus, CopyPlus, Check, Search } from 'lucide-react';
...
const PackageItemForm = ({ items, setItems }: PackageItemFormProps) => {
      ...
      <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-4">
              ...
              {expanded.includes(index) && (
                <div className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor={`item-country-${index}`}>Country of Origin</Label>
                      <Input
        ...
        {items.length === 0 && (
          <div className="text-center p-6 border border-dashed rounded-md bg-muted/30">
            <CopyPlus className="h-12 w-12 mx-auto text-muted-foreground" />
